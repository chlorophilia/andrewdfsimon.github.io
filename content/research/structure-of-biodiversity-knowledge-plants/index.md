---
title: "The structure of biodiversity knowledge, Part III: vascular plants of Galiano Island"
tags: ["community science", "Galiano Island", "biodiversity science", "botany"]
summary: "Harvey Janszen's decades of fieldwork, a decade-old identification correction, and 800 species: the last of three posts on ten years of Biodiversity Galiano—and the one that leads directly into a later paper about local extinction."
image: "thumb.jpg"
_build:
  render: never
  list: never
...
<div class="figure">
<img src="plants-network.jpg" alt="Network diagram of vascular plant records on Galiano Island, showing Harvey Janszen and Gerald Straley as major historical hubs" />
<p class="caption">Harvey Janszen's decades of fieldwork form the densest historical cluster in the plant diagram—the same body of knowledge behind two extirpation calls in a <a href="/research/detecting-extinction-at-two-scales/">later paper</a>.</p>
</div>
...
The densest historical cluster in this graph belongs to Harvey Janszen, whose decades of fieldwork on Galiano I've written about [elsewhere](/research/detecting-extinction-at-two-scales/)—the same body of knowledge that let a later paper call two local plant extirpations with real confidence. Gerald Straley, a UBC botanist, forms the diagram's other major historical hub.
